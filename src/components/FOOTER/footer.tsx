...
function FOOTER() {
  return (
    <main>
      <div className="flex justify-around items-center mt-[60px] pl-[300px] pr-[300px] border-y-[1px] border-[#E1E3E5] text-[#272343] pb-[50px]">
        <div className="flex flex-col gap-[24px]">
          ...
          <div className="w-[350px]">
            <p className="w-[340px] text-[16px] font-inter font-normal leading-[24px">
        ...
        <div className="flex flex-col gap-[20px] list-none">
        ...
        <div className="pb-[30px] flex flex-col gap-[20px]">
          ...
          <p className="w-[410px] text-[15px] font-inter font-normal leading-[24px">

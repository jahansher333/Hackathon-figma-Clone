...
function section6() {
  return (
    <main className='flex flex-col gap-[70px] mt-[150px]'>
    <h1 className='text-[32px] font-inter font-bold leading-[36.8px] text-[#272343] text-center'>Our Products</h1>
     <div className='grid grid-cols-4 gap-2 justify-center items-center pl-[300px] pr-[300px]'>
        ...
        <div className='w-[312px] h-[377px] bg-[#FFFFFF]'>
          <Image src="/images/Image.png" alt="chair" width={312} height={312}/>
          <div className='flex justify-between mt-[10px]'>
          <div className='flex flex-col gap-[7px]'>
            <p className='text-[16px] font-inter font-normal leading-[20.8px] text-[#007580]'>Library Stool Chair</p>
            <p className="text-[18px] font-inter leading-[19.8px]">$20</p>

...
function SECTION1() {
  return (
    ...
    <section className="bg-gray-50 w-[1321px] min-h-screen flex justify-center items-center m-auto px-8 md:px-20 rounded-b-[48px]">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-7xl mx-auto">
        ...
        <div className="text-left flex flex-col gap-[15px]">
          ...
          <h1 className="w-[557px] text-[60px] font-bold text-gray-800  leading-[66px]">
